/**
 * @generated SignedSource<<de62609c372823935748fa7096145378>>
...
export type GetNotificationsQuery$variables = {
  after?: any | null;
  first: number;
};
export type GetNotificationsQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"NotificationsTable_notification">;
};
export type GetNotificationsQuery = {
  response: GetNotificationsQuery$data;
  variables: GetNotificationsQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "fc452f32f24face5bfe0f41b3b37a03e",
    "id": null,
    "metadata": {},
    "name": "GetNotificationsQuery",
    "operationKind": "query",
...
(node as any).hash = "40d5e6ce954447798c58861063844f14";
