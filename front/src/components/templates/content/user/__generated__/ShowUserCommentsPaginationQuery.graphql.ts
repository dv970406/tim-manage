...
export type ShowUserCommentsPaginationQuery$variables = {
  after?: any | null;
  first: number;
  id: string;
};
...
export type ShowUserCommentsPaginationQuery = {
  response: ShowUserCommentsPaginationQuery$data;
  variables: ShowUserCommentsPaginationQuery$variables;
};
